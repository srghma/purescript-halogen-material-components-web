...
heroCard =
  Card.card
    ...
    { blocks: Array.singleton $ Card.primaryAction []
        [ demoMedia
        , demoTitle
        , demoBody
        ]
...
demoMedia =
    Card.mediaView (Just Card.SixteenToNine) [] "https://aforemny.github.io/material-components-web-elm/images/photos/3x2/2.jpg"
