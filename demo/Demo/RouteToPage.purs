...
pagesRec = spy "pagesRec"
  ...
  , "TopAppBar_Standard":       Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.Standard.config
  , "TopAppBar_Fixed":          Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.Fixed.config
  , "TopAppBar_Dense":          Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.Dense.config
  , "TopAppBar_Prominent":      Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.Prominent.config
  , "TopAppBar_Short":          Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.Short.config
  , "TopAppBar_ShortCollapsed": Demo.HOC.TopAppBarPage.mkComponent Demo.Pages.TopAppBar.ShortCollapsed.config
  , "Drawer_Permanent":         Demo.HOC.DrawerPage.mkComponent Demo.Pages.Drawer.Permanent.config
  , "Drawer_Dismissible":       Demo.HOC.DrawerPage.mkComponent Demo.Pages.Drawer.Dismissible.config
  , "Drawer_Modal":             Demo.HOC.DrawerPage.mkComponent Demo.Pages.Drawer.Modal.config
  }
