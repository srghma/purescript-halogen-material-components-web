...
alignStart = HP.class_ "mdc-top-app-bar__section--align-start"

{-| End-align a top app bar's `section`
-}
alignEnd :: HH.Attribute r i
alignEnd = HP.class_ "mdc-top-app-bar__section--align-end"

navigationIcon :: HH.Attribute r i
navigationIcon = HP.class_ mdc_top_app_bar__navigation_icon

title :: HH.Attribute r i
title = HP.class_ mdc_top_app_bar__title

actionItem :: HH.Attribute r i
actionItem = HP.class_ mdc_top_app_bar__action_item

rootCs :: Maybe (HH.Attribute r i)
rootCs = Just (HP.class_ mdc_top_app_bar)

variantCs :: Variant -> Maybe (HH.Attribute r i)
variantCs variant = case variant of
  Regular -> Nothing
  Short -> Just (HP.class_ mdc_top_app_bar____short)
  ShortCollapsed -> Just (HP.class_ "mdc-top-app-bar--short mdc-top-app-bar--short-collapsed")
...
fixedAdjust = HP.class_ "mdc-top-app-bar--fixed-adjust"

denseFixedAdjust :: HH.Attribute r i
denseFixedAdjust = HP.class_ "mdc-top-app-bar--dense-fixed-adjust"

shortFixedAdjust :: HH.Attribute r i
shortFixedAdjust = HP.class_ "mdc-top-app-bar--short-fixed-adjust"

prominentFixedAdjust :: HH.Attribute r i
prominentFixedAdjust = HP.class_ "mdc-top-app-bar--prominent-fixed-adjust"

denseProminentFixedAdjust :: HH.Attribute r i
denseProminentFixedAdjust = HP.class_ "mdc-top-app-bar--dense-prominent-fixed-adjust"
