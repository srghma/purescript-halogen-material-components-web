...
labelElt config =
    case config.label of
      Just str ->
        HH.div
          [ if Maybe.fromMaybe "" config.value /= ""
            then HP.classes [ mdc_floating_label, mdc_floating_label____float_above ]
            else HP.class_ mdc_floating_label
